...
public class VerificationMessages {
    public static final String VERIFICATION_ALREADY_PENDING =  "Doğrulama zaten beklemede.";
    public static final String VERIFICATION_ALREADY_APPROVED =  "Doğrulama zaten onaylandı.";
